import { w as withLeadingSlash, o as joinURL, x as withoutTrailingSlash, S as withBase, z as hash } from '../nitro/nitro.mjs';
import { t as useRuntimeConfig } from './server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-40rg1CPR.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DwB5JNrv.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CyElgvY2.mjs.map
