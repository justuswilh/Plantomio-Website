    ...
    <div v-if="shouldShowBanner" class="cookie-banner">
      <div class="cookie-content">
        <p>
          ...
          Weitere Informationen finden Sie in unserer <NuxtLink href="/datenschutz" class="underline text-white">Datenschutz</NuxtLink>.
        </p>
        <div class="cookie-buttons">
            <UButton @click="acceptCookies" color="primary" variant="outline">Akzeptieren</UButton>
            <UButton @click="rejectCookies" color="error" variant="outline">Ablehnen</UButton>
        </div>
      </div>
    </div>
  </template>
